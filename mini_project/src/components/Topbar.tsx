    ...
    <header className="sticky top-0 z-40 h-20 border-b border-white/10 bg-zinc-950/75 px-6 backdrop-blur-2xl">
      <div className="mx-auto flex h-full items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          {/* Search */}
          <div className="group hidden w-[280px] items-center gap-3 rounded-xl border border-white/10 bg-white/[0.04] px-3.5 py-2.5 transition-all duration-300 hover:border-white/15 hover:bg-white/[0.07] focus-within:border-blue-500/40 focus-within:bg-blue-500/[0.04] focus-within:ring-4 focus-within:ring-blue-500/5 md:flex">
            <Search
              size={17}
